...
class FlickrClient {
    ...
    func searchBy(latitude: Double, longitude: Double, totalPages: Int?, completion: @escaping (_ result: PhotosParser?, _ error: Error?) -> Void) {
        ...
        // computed property to choose a random page
        var page: Int {
    ...
    func taskForGETMethod(_ method : String? = nil, _ customUrl: URL? = nil, parameters : [String: String], completionHandlerForGET: @escaping (_ result: Data?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        let task = session.dataTask(with: request as URLRequest) { (data, response, error) in
            ...
            //if error occurs cancel the request
            if let error = error {
            ...
            //check of the response status code was successful
